...
const Page = () => {
  ...
  const [name, setName] = useState(" demo@devias.io");
            ...
            {method === "email" && (
              <form noValidate>
                ...
                <Stack spacing={5}>
                  ...
                  <TextField fullWidth label="Email" name="password" type="password" />
                  <TextField fullWidth label="Location" name="email" type="email" />
                  <TextField fullWidth label="Phone" name="email" type="email" />
                </Stack>
